    ...
    <div class="flex-1 flex flex-col h-full bg-[var(--bg-app)] overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto p-5 pt-4 custom-scrollbar space-y-12 pb-20">
            ...
            <section class="space-y-4">
                ...
                <div class="bg-[var(--bg-card)] p-6 rounded-[32px] border border-[var(--color-border)] shadow-sm space-y-4">
                    <div
                    ...
                    >
                        <div class="flex items-center gap-3">
                            <div :class="['w-8 h-8 rounded-lg flex items-center justify-center text-white text-xs font-black', p.provider === 'vkid' ? 'bg-[#0077FF]' : 'bg-[#4285F4]']">
